...
$('input.non-veg-appetizer-checkbox').on('change', function(evt) {
 ...
 function print_menu(){
    document.getElementById("modal_to_print").innerHTML = "";
    document.getElementById("modal_to_print").innerHTML += `<h1 class="hs-line-14 font-alt mb-50 mb-xs-30 dream-primary-color">Dream Banquet Hall</h1>`;
    document.getElementById("modal_to_print").innerHTML += `<h1 class="hs-line-3 font-alt mb-50 mb-xs-30 dream-primary-color">Menu</h1>`;
